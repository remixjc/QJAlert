; (function (window, document, undefined) {
    ...
    (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
        1: [function (require, module, exports) {
             ...
             */
            var sweetAlert, qjalert;

            exports['default'] = sweetAlert = qjalert = function () {
             ...
             */
            sweetAlert.setDefaults = qjalert.setDefaults = function (userParams) {
                if (!userParams) {
             ...
             */
            sweetAlert.close = qjalert.close = function () {
                var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
             ...
             */
            sweetAlert.showInputError = qjalert.showInputError = function (errorMessage) {
                var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
             ...
             */
            sweetAlert.resetInputError = qjalert.resetInputError = function (event) {
             ...
             */
            sweetAlert.disableButtons = qjalert.disableButtons = function (event) {
                var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
             ...
             */
            sweetAlert.enableButtons = qjalert.enableButtons = function (event) {
                var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
                var $confirmButton = modal.querySelector('button.confirm');
                var $cancelButton = modal.querySelector('button.cancel');
            ...
            if (typeof window !== 'undefined') {
                ...
                window.sweetAlert = window.qjalert = sweetAlert;
            } else {
                    ...
                    var _ret = (function () {
                        ...
                        switch (params.type) {
                            ...
                            case 'prompt':
                                ...
                                setTimeout(function () {
                                    $input.focus();
                                    $input.addEventListener('keyup', qjalert.resetInputError);
                                }, 400);
                                break;
                        }
                    })();
